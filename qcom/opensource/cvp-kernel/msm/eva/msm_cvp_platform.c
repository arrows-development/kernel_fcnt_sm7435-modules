...
static struct msm_cvp_common_data sm7435_common_data[] = {
	{
		.key = "qcom,auto-pil",
		.value = 1,
	},
...
static struct msm_cvp_platform_data sm7435_data = {
	.common_data = sm7435_common_data,
	.common_data_length =  ARRAY_SIZE(sm7435_common_data),
	.sku_version = 0,
	.vpu_ver = VPU_VERSION_5,
